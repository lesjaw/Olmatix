...
public class SnackbarWrapper {
    ...
    @Nullable
    private TSnackbar.Callback externalCallback;
    @Nullable
    private Action action;

    @NonNull
    public static SnackbarWrapper make(@NonNull Context applicationContext, @NonNull CharSequence text, @TSnackbar.Duration int duration)
    {
        return new SnackbarWrapper(applicationContext, text, duration);
    }

    private SnackbarWrapper(@NonNull final Context appplicationContext, @NonNull CharSequence text, @TSnackbar.Duration int duration)
    {
    ...
    {
        TSnackbar snackbar = TSnackbar.make(snackbarContainer, text, duration);
    ...
    @NonNull
    public SnackbarWrapper setCallback(@Nullable TSnackbar.Callback callback)
    {
