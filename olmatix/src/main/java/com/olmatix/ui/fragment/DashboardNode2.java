...
public class DashboardNode2 extends Fragment implements OnStartDragListener {
    ...
    class RecyclerTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        private DashboardNode2.ClickListener clicklistener;
        private GestureDetector gestureDetector;

        RecyclerTouchListener(Context context, final RecyclerView recycleView, final DashboardNode2.ClickListener clicklistener){
